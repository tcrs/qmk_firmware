...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_3key_1us(
     ...
     KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LSFT,          KC_RSFT, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
     KC_NUBS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LSFT,          KC_RSFT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
     KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ENT,           KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_NUHS,
     KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL,       MO(_RAISE), KC_LSFT,          KC_SPC,  MO(_RAISE),       KC_RCTL, KC_RALT, KC_APP,  KC_RSFT
  ),
